...
( function ( $ ) {
	...
	$( 'document' ).ready( function () {
		...
		var $window = $( window ),
			...
			site_wrapper = imagesLoaded( '.homepage-slider' );
...
function initMap () {
	var 
		...
		uluru = {lat: 25.206805, lng: 55.290515},
...
document.addEventListener('DOMContentLoaded', function () {
    var pushbar = document.getElementById('offcanvas-menu');
    if (!pushbar) return;

    pushbar.querySelectorAll('.menu-item-has-children > a').forEach(function (link) {
